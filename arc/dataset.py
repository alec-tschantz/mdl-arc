...
class Dataset:
    def __init__(
        ...
        *,
        ...
        self.output_masks = np.stack(output_masks).astype(bool)
    ...
    def __iter__(self):
        ...
        for start in range(0, usable, self.batch_size):
            ...
            output_mask = self.output_masks[batch_idx].reshape(batch_size, -1)
